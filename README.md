...
or
create yaml file from vault-values.yml which will contain deployment, svc, configmaps, secrets, etc. and store it in templates folder:
...
or again
create yaml file from vault-unseal-values.yml which will contain our cronjob yaml file and store it in templates folder:
